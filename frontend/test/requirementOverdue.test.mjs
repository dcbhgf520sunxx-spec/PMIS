...
test('需求展示后端返回天数，不受浏览器当前时间影响', () => {
  for (const now of ['2026-09-21T00:01:00+08:00','2026-09-21T07:59:00+08:00','2026-09-21T08:01:00+08:00','2026-09-21T23:59:00+08:00']) {
    assert.equal(renderAt(now, true, 1), 1);
  }
  assert.equal(renderAt('2026-10-01T00:01:00+08:00', true, 2), 2);
  assert.equal(renderAt('2026-09-21T12:00:00+08:00', false, 1), 0);
});
