...
export function ProjectDetailPage() {
  ...
  return (
    <TemplateDetailPage
      ...
      documentSection={row ? { items: [
        { label: '创建人', value: row.creatorName }, { label: '创建时间', value: row.createdAt, wide: true },
        { label: '更新人', value: row.updaterName }, { label: '更新时间', value: row.updatedAt, wide: true },
      ] } : null}
    >
      {row ? (
        <>
          ...
          <TemplateDetailSection title="进展与风险" sectionKey="project-progress">
            <DetailMetaList items={[
              { label: '进度记录', value: row.progressText, wide: true, longText: true },
