    ...
    <>
      ...
      <HistoryTimelineSection
        ...
        items={[
          ...
          { id: 'history-1', operator: '业务管理员', action: '更新负责区域', time: '2026-07-12 09:30', changes: [{ field: '对象编号', after: 'AREA-001', changeMode: 'values' }, { field: '负责区域', before: '总部园区', after: '总部园区、华东区域' }] },
