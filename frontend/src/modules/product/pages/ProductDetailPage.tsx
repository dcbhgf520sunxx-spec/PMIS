...
export function ProductDetailPage() {
  ...
  return (
    ...
    >
      {row ? <><TemplateDetailSection title="基本信息"><DetailMetaList items={[{ label: '产品名称', value: row.name }, { label: '负责人', value: row.ownerName }, { label: '产品描述', value: <RichTextViewer value={row.description} />, wide: true }]} /></TemplateDetailSection><HistoryTimelineSection items={history} /></> : null}
    </TemplateDetailPage>
  );
}
