...
import { DeleteConfirmAction, DetailMetaList, HistoryTimelineSection, PermissionButton, RichTextViewer, StatusConfirmAction, StatusTag, TemplateDetailPage, TemplateDetailSection , usePageReturnNavigation } from '../../../components/admin';
...
export function ProductDetailPage() {
  ...
  return (
    ...
    >
      {row ? <><TemplateDetailSection title="基本信息"><DetailMetaList items={[{ label: '产品名称', value: row.name }, { label: '负责人', value: row.ownerName }, { label: '产品描述', value: <RichTextViewer value={row.description || '暂无描述'} />, wide: true }]} /></TemplateDetailSection><HistoryTimelineSection items={history} /></> : null}
    </TemplateDetailPage>
  );
}
